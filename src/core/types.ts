...
export interface TextStyle {
    ...
    fontSize?: { magnitude?: number | null; unit?: string | null };
    foregroundColor?: { color?: Color };
    link?: {
        url?: string | null;
        bookmarkId?: string | null;
        headingId?: string | null;
        bookmark?: { id?: string | null; tabId?: string | null };
        heading?: { id?: string | null; tabId?: string | null };
    };
}
...
export interface InlineObjectProperties {
    embeddedObject?: {
        imageProperties?: { contentUri?: string | null };
        size?: { width?: { magnitude?: number | null; unit?: string | null }; height?: { magnitude?: number | null; unit?: string | null } };
    };
}
